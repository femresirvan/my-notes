//inherite alınan sınıf parent sınıftır.
/**
...
class Kopek extends Hayvan {
  ...
  @override // aldığı parametreler aynı fakat içerik farklı olur.
  // üzerine yazdığımız fonksiyon tamamen yeniden yazarız. Eğer eski özellikleri kullanmak istersek super objesini kullanırız.
  void yemekYe() {
    print("Kopek yemek yiyor");
    //super.yemekYe(); yaparsan üst sınıfa çık sonra da onu çalıştır diyoruz.
  }
}
